        ...
        form.parse(req, async (err, field, files) => {
            ...
            try {
                ...
                for (let i = 0; i < images.length; i++) {
                    const result = await cloudinary.uploader.upload(images[i].filepath, { folder: 'shopp/products' })
        ...
        form.parse(req, async (err, field, files) => {
            ...
            if (err) {
                ...
                try {
                    ...
                    const result = await cloudinary.uploader.upload(newImage.filepath, { folder: 'shopp/products' })
